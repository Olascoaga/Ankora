...
- Recorded scientist acceptance of HIE at HIS A:179 and CYM at CYS
  A:238/CYS A:242 in both TP53 templates, while calling out the existing CYM
  default at CYS A:176.
- Re-hashed the confirmed review and verified that final receptor preparation
  can retrieve exactly the three accepted overrides for either TP53 template.
  No final receptor, PDBQT, docking result, or enrichment metric was created.
